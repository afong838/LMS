        ...
        const renderTableSection = () => {
            return (
                <>
                                    ...
                                    <StyledTableRow>
                                        ...
                                        <StyledTableCell align="center">
                                            ...
                                            <Button variant="contained" sx={styles.attendanceButton}
                                                onClick={() => navigate(`/SuperAdmin/subject/student/attendance/${studentID}/${subId}`)}>
                                                Change
                                            </Button>
                                        </StyledTableCell>
                                    </StyledTableRow>
                    ...
                    <Button variant="contained" sx={styles.styledButton} onClick={() => navigate("/SuperAdmin/students/student/attendance/" + studentID)}>
                        Add Attendance
                    </Button>
                </>
            )
        ...
        const renderTableSection = () => {
            return (
                <>
                    ...
                    <Button variant="contained" sx={styles.styledButton} onClick={() => navigate("/SuperAdmin/students/student/marks/" + studentID)}>
                        Add Marks
                    </Button>
                </>
            )
