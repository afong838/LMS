...
import { SAgetAllStudents } from '../../../redux/studentRelated/studentHandle';
...
const ShowStudents = () => {
    ...
    useEffect(() => {
        dispatch(SAgetAllStudents(currentUser._id));
                ...
                <>
                    {response ?
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', marginTop: '16px' }}>
                            <GreenButton variant="contained" onClick={() => navigate("/SuperAdmin/addstudents")}>
                                Add Students
                            </GreenButton>
                        </Box>
                        :
