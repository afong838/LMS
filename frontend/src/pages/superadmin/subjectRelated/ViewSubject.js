    ...
    return (
      <>
        ...
        <PurpleButton
          variant="contained"
          onClick={() =>
            navigate(`/SuperAdmin/subject/student/attendance/${row.id}/${subjectID}`)
          }
        >
          Take Attendance
        </PurpleButton>
    ...
    return (
      <>
        ...
        <PurpleButton variant="contained"
          onClick={() => navigate(`/SuperAdmin/subject/student/marks/${row.id}/${subjectID}`)}>
          Provide Marks
        </PurpleButton>
      </>
    );
      ...
      <>
        ...
        {subjectDetails && subjectDetails.teacher ?
          ...
          <GreenButton variant="contained"
            onClick={() => navigate("/SuperAdmin/teachers/addteacher/" + subjectDetails._id)}>
            Add Subject Teacher
          </GreenButton>
        }
      </>
